...
class AnalysisService:
    ...
    def generate_suggestions(self, sentiment: Any, emotion: Any) -> List[str]:
        # Basic logic to generate suggestions based on top emotion/sentiment
        suggestions = []
        
        # If AI model returned error, don't try to parse scores
        if isinstance(sentiment, dict) and "error" in sentiment:
            return ["AI model is still loading. Suggestions will be available shortly."]
